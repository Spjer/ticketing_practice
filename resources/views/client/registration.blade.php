        ...
        <div class="card-body" >
            ...
            @csrf
                ...
                <div>
                    ...
                    <input type="text" class="form-control form-control-lg" placeholder="aaaa.aaaaaa@email.aa" id="email" name="email" required autofocus>
                    @if ($errors->has('email'))
                ...
                <label for="phone_number" class="form-label">Phone number:</label><br>
                    <input type="tel" class="form-control form-control-lg" placeholder="xxx-xxx-xxxx" id="phone_number" name="phone_number" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3-4}" required autofocus>
                ...
                <div>
                    ...
                    <input type="password" class="form-control form-control-lg" placeholder="********" id="password" name="password" aria-labelledby="passwordHelpBlock" required>
